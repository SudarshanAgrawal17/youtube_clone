...
function Header() {
    ...
    const searchQueryHandler = (event) => {
        if ((event?.key === "Enter" || event === "searchButton") && searchQuery.length > 0) { // will navigate to the mentioned URL when pressed enter or the search button is clicked.
        ...
        <div className='sticky top-0 z-10 flex flex-row items-center justify-between h-14 px-4 md:px-5 bg-white dark:bg-black'>
            ...
            <div className="flex items-center">
                ...
                <div className="flex h-8 w-8 overflow-hidden rounded-full md:ml-4">
                    <img src="https://source.unsplash.com/100x100/?face&random" className='cursor-pointer' />
                </div>
            </div>
        </div>
    )
